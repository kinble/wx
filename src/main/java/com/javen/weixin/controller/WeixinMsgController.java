...
//		render(outCustomMsg);
	 ...
	 * @param inMenuEvent
	 */
	public void doEvent(InMenuEvent inMenuEvent){
		...
		//主动推送信息给指定用户
		//final String toUser = inMenuEvent.getFromUserName();
		//ApiResult sendText = CustomServiceApi.sendText("oLdOB1NY_i_eRbTvPsDQH_iirgMc", "客服消息1111");
		//ApiResult sendText = CustomServiceApi.sendText("oLdOB1NY_i_eRbTvPsDQH_iirgMc", "客服消息1111");
